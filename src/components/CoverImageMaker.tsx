                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '5px' }}>
                  {PRESETS.map(p => (
                    <button
                      ...
                      style={{ height: '34px', background: `linear-gradient(${p.direction}, ${p.color1}, ${p.color2})`, borderRadius: '6px',
                        // loose match: highlight when both colors match, regardless of direction/textColor
                        border: color1 === p.color1 && color2 === p.color2 ? '2px solid var(--c-accent)' : '2px solid transparent', cursor: 'pointer', fontSize: '0.65rem', color: p.textColor, fontFamily: 'var(--font-display)', fontWeight: 600, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', padding: '0 4px' }}
                    >
                      {p.name}
                    </button>
                  ))}
              ...
              <div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.45rem' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    ...
                    <input type="text" value={color1} onChange={e => setColor1(e.target.value)} maxLength={7} style={inputStyle} />
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    ...
                    <input type="text" value={color2} onChange={e => setColor2(e.target.value)} maxLength={7} style={inputStyle} />
